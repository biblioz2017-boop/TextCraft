...
# The patch deliberately anchors only to stable AboutButton declarations.
# Do not anchor to DefaultCheckBox or other controls modified by earlier build patches.
...
Write-Host 'NeZnaika embedded help ribbon UI applied using stable anchors.'
