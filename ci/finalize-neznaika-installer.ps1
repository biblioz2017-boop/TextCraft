...
try {
    Write-Host ''
    Write-Host 'NeZnaika 1.0.26 - Microsoft Word add-in setup' -ForegroundColor Cyan
    Write-Host '================================================'
    ...
    Write-Host '[4/4] Done.'
    Write-Host ''
    Write-Host 'NeZnaika 1.0.26 was installed successfully.' -ForegroundColor Green
...
@echo off
cd /d "%~dp0"
title NeZnaika 1.0.26 Installer
