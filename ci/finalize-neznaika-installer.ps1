...
try {
    Write-Host ''
    Write-Host 'NeZnaika 1.0.16 - Microsoft Word add-in setup' -ForegroundColor Cyan
    Write-Host '================================================'
    ...
    Write-Host '[4/4] Done.'
    Write-Host ''
    Write-Host 'NeZnaika 1.0.16 was installed successfully.' -ForegroundColor Green
...
# CI guard 1: executable installer sources must stay strictly ASCII.
...
# CI guard 2: ask the actual Windows PowerShell 5.1 parser to parse the final file.
# This does not execute the installer.
